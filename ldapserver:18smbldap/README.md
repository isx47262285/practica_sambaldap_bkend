## robert72004/ldapserver_18roberto:ldapsmb


## roberto@edt ASIX M06-ASO Curs 2018-2019

Servidor ldap amb edt.org, con un samba.schema includio en la configuracion de slapd.conf
### objetivo:
> incluir un schema de samba para poder hacer el backend y utilizar las dades desde el ldap 
con el populate.ldif 
...
```
$ docker run --rm --name ldap -h ldap --net sambanet -d robert72004/ldapserver_18roberto:ldapsmb 
```

#### configuracion del slapd.conf 
>importante! añadir la linea de include  del fichero samba.schema en la config
...
##### configuracion del samba.schema 
